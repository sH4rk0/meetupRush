    ...
    var initList = (function () {
        ...
        initList.prototype.loadRsvp = function () {
            ...
            if (this.rsvpData == null) {
                ...
                var _url = "https://api.meetup.com/2/rsvps?offset=0&format=json&event_id=234547391&photo-host=public&page=100&fields=&order=name&desc=false&sig_id=199420979&sig=88ec44e6df450a40b3ee0314dd7bf21086a23ccf&key=7c4e4e1e49637797153e102a78283f&sign=true";
                $.ajax({
                    type: "GET",
                    url: _url,
                    dataType: 'jsonp',
